...
#
FILE_DA_CONSEGNARE=Makefile chatty.c mylib.h  message.h ops.h stats.h stats.c  config.h \
		   DATA/chatty.conf1 DATA/chatty.conf2 DATA/script.sh connections.h connections.c \
		   parset.h parset.c queue.h queue.c icl_hash.h icl_hash.c user.h user.c \
		   history.h history.c listener.c sup_icl.c sup_icl.h Doxyfile Relazione.pdf
...
test1:
	...
	./client -l $(UNIX_PATH) -k minni -S "ciao a tutti":
